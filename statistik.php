    ...
    <main class="content-wrapper">
        <section class="header-section text-center p-4 rounded-4 mb-5">
            ...
            <p class="lead mx-auto" style="max-width: 700px; color: white">
                 22Halaman ini menyediakan daftar kontak penting yang dapat dihubungi saat terjadi bencana gunung meletus, serta fitur untuk melaporkan kondisi di lokasi Anda.
            </p>
        </section>
